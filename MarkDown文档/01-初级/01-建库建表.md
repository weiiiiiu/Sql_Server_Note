...
![image-20240519192728688](https://raw.githubusercontent.com/weiiiiiu/pic/master/img/202405201819094.png)
...
(
	...
	--references代表外键引用（使用另一张表主键）,此字段在另一张表必须存在
...
例如需要改变邮箱列的数据类型为varchar(100)  原本101设置100会截断 类型相同
...
![image-20240520215243649](https://raw.githubusercontent.com/weiiiiiu/pic/master/img/202405202157740.PNG)
...
Unique Key 可以有多个字段，而且可以为空，但只能有一个为空，而主键约束则只允许有一个字段，且不能为空
