...
此写法在给字段赋值的时候，<u>必须保证顺序和数据表结构中字段顺序完全一致，不推荐使用此种写法</u>，因为数据表结构变化的时候，数据会出错或产生错误数据。
**更改字段顺序**

![image-20240520222237157](https://raw.githubusercontent.com/weiiiiiu/pic/master/img/202405202222304.png)
